...
import iskallia.ibuilders.gui.container.GuiContainerCreatorWorkers;
...
public class GuiHandler implements IGuiHandler {
    ...
    public static final int CREATOR_WORKERS = 2;
    ...
    public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        } else if(id == CREATOR_WORKERS) {
            TileEntity tileEntity = world.getTileEntity(new BlockPos(x, y, z));
            if(tileEntity instanceof TileEntityCreator) {
                return new ContainerCreatorWorkers(player, (TileEntityCreator)tileEntity);
            }
        }
    ...
    public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        if(id == SCHEMATIC_TERMINAL) {
            ...
            TileEntity tileEntity = world.getTileEntity(new BlockPos(x, y, z));
            if(tileEntity instanceof TileEntityCreator) {
                return new GuiContainerCreatorWorkers(player, (TileEntityCreator)tileEntity);
            }
        }
